...
public class Menu_tg extends AppCompatActivity {
    TabLayout tb_tg1;
    ViewPager2 vp_tg1;
    TableLayout tl_tg1;
    Menu_tg This;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.act_menu_tg);

        tb_tg1=findViewById(R.id.tb_tg1);
        vp_tg1=findViewById(R.id.vp_tg1);
        tl_tg1=findViewById(R.id.tl_tg1);
        ...
        pay2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (tl_tg1.getChildAt(0) != null) {
                    Intent intent = new Intent(Menu_tg.this, Pay_tg.class);

                    for (int i = 0; i < tl_tg1.getChildCount(); i++) {
                        LinearLayout linearLayout = (LinearLayout) tl_tg1.getChildAt(i);
                    ...
                    intent.putExtra("횟수", tl_tg1.getChildCount());
        ...
        vp_tg1.setAdapter(new FragmentStateAdapter(this) {
            @NonNull
            @Override
        ...
        for (int i=0;i<6;i++)
        {
            TabLayout.Tab tab=tb_tg1.newTab();
            if(i==0)
            {
        ...
        tb_tg1.addOnTabSelectedListener(new TabLayout.OnTabSelectedListener() {
            @Override
            public void onTabSelected(TabLayout.Tab tab) {
                vp_tg1.setCurrentItem(tab.getPosition());
            }
        ...
        vp_tg1.registerOnPageChangeCallback(new ViewPager2.OnPageChangeCallback() {
            @Override
            public void onPageSelected(int position) {
                tb_tg1.selectTab(tb_tg1.getTabAt(position));
            }
        });
    }
    ...
    {
        for (int i = 0; i < tl_tg1.getChildCount(); i++) {
            LinearLayout ll = (LinearLayout) tl_tg1.getChildAt(i);
    ...
    public void vanilla_bean_latte(View view)
    {
        topping_vanilla_bean_latte(false,true,true);
    }

    public void ice_vanilla_bean_latte(View view)
    {
        topping_ice_vanilla_bean_latte(false,true,true);
    }

    public void topping_vanilla_bean_latte(boolean icy,boolean vanilla,boolean hazelnut)
    {
        ...
        ok.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (ice.isChecked())
                {
                    Menu_tg.this.topping_price+=500;
                    Menu_tg.this.icy=true;
                }

                if (syrup_vanilla.isChecked())
                {
                    Menu_tg.this.topping_price+=600;
                    Menu_tg.this.vanilla=true;
                }

                if (syrup_hazelnut.isChecked())
                {
                    Menu_tg.this.topping_price+=700;
                    Menu_tg.this.hazelnut=true;
                }

                toppingDialog.dismiss();

                String name="바닐라 빈 라떼";
                ...
                if (Menu_tg.this.vanilla)
                {
                    name+="(바닐라)";
                }

                if (Menu_tg.this.hazelnut)
                {
                    name+="(헤이즐넛)";
                }
    ...
    public void topping_ice_vanilla_bean_latte(boolean icy,boolean vanilla,boolean hazelnut)
    {
        this.topping_price=0;
        this.icy=false;
        this.vanilla=false;
