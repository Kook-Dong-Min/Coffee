...
public class Pay_fh extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.act_pay_fh);
        ...
        pay_pay1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                AlertDialog.Builder alertbuilder=new AlertDialog.Builder(Pay_fh.this);
                ...
                alertbuilder.setPositiveButton("네", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        Toast.makeText(Pay_fh.this,"결제되었습니다.",Toast.LENGTH_LONG).show();
                    }
                });
